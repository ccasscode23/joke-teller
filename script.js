...
// Disable/Enable button when joke is being told
...
function tellMe(joke) {
    VoiceRSS.speech({
                key: '17484f58a2084a7c8dd3c9adb0afc278',
                src: joke,
                hl: 'en-us',
                r: 0,
                c: 'mp3',
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Pun,Spooky?blacklistFlags=racist,sexist'
    try {
